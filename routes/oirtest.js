...
const {
  ...
  savetwo,
  savereturntwo,
} = require("../controllers/oirtest/two.js");
const {
  three,
  savethree,
  savereturnthree,
} = require("../controllers/oirtest/three");
const {
  four,
  savefour,
  savereturnfour,
} = require("../controllers/oirtest/four");
const {
  five,
  savefive,
  savereturnfive,
} = require("../controllers/oirtest/five");
// Final Oir Test
const {
  finalOir,
  savefinalOir,
  savefinalreturnOir,
} = require("../controllers/oirtest/final");
